...
\begin{axis}[
    ...
    xmin=-3.25, xmax=3.25, ymin=-1.4, ymax=1.4, 
    xtick={-3, -2,...,3},
    ytick={-1,-0.5,...,1},
    grid = both
]
\addplot [color=itwm_blue_04, ultra thick,] coordinates {(-3,0) (-2, 1)};
\addplot [color=itwm_blue_04, ultra thick,] coordinates {(-2,-1) (0, 1)};
\addplot [color=itwm_blue_04, ultra thick,] coordinates {(0,-1) (2, 1)};
\addplot [color=itwm_blue_04, ultra thick,] coordinates {(2,-1) (3, 0)};
\addplot [color=itwm_blue_04, thick, dashed] coordinates {(-2,-1) (-2, 1)};
\addplot [color=itwm_blue_04, thick, dashed] coordinates {(0,-1) (0, 1)};
\addplot [color=itwm_blue_04, thick, dashed] coordinates {(2,-1) (2, 1)};
\end{axis}
\end{tikzpicture}
\end{document}